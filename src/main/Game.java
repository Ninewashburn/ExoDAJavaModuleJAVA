...
public class Game {
    ...
    private static String joueur1 = Utilitaires.saisieString();
    private static String joueur2 = Utilitaires.saisieString();

    public static String getJoueur1() {
        return joueur1;
    }

    public static void setJoueur1(String joueur1) {
    ...
    public static void setJoueur2(String joueur2) {
    ...
    public void debutTour() {
        ...
        if (!over) {
            ...
            if (numTour % 2 == 1) joueurActuel = this.listeJoueurs.get(0);
            else joueurActuel = this.listeJoueurs.get(1);
    ...
    private void jouer(Joueur j) {
        ...
        while (!temp2) {
            ...
            while (!temp) {
                ...
                if (selectionnee != null) temp = true;
            }
    ...
    private Position getEntree(int n) {
        String temp = null;
        if (n == 1) temp = "Entrez la position de depart (x puis y)";
        if (n == 2) temp = "Entrez la position d'arriv�e (x puis y)";
    ...
    private void update() {
        ...
        for (Roi count : Roi.tabRoi) {
            ...
            else if (count.isEchec() && count.isEchecEtMat() || count.echecEtPat) {
                over = true;
                System.out.println("Le roi " + count.getCouleur() + " est en " + t + "\n");
                if (coul.equals(Couleur.WHITE)) System.out.print("Le joueur " + this.listeJoueurs.get(0));
                else System.out.print("Le joueur " + this.listeJoueurs.get(1));
